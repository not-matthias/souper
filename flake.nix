  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        llvmLib = pkgs.llvmPackages_18.llvm.lib or pkgs.llvmPackages_18.llvm;
        ...
        alive2 = pkgs.stdenv.mkDerivation rec {
          ...
          buildInputs = [ z3-souper pkgs.llvm_18 ];
      ...
      in
      {
        packages = rec {
          souper = pkgs.stdenv.mkDerivation rec {
            ...
            buildInputs = with pkgs; [
              ...
              llvmPackages_18.llvm.dev  # Provides llvm-config
            ...
            preConfigure = ''
              ...
              cp -r ${pkgs.llvmPackages_18.llvm}/bin/* third_party/llvm-Release-install/bin/ 2>/dev/null || true
              cp -r ${pkgs.llvmPackages_18.llvm.dev}/bin/* third_party/llvm-Release-install/bin/ 2>/dev/null || true

              # Link include and lib
              ln -sf ${pkgs.llvmPackages_18.llvm.dev}/include/* third_party/llvm-Release-install/include/ 2>/dev/null || true
              ln -sf ${pkgs.llvmPackages_18.llvm}/lib/* third_party/llvm-Release-install/lib/ 2>/dev/null || true
            '';
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo "LLVM version: ${pkgs.llvmPackages_18.llvm.version}"
